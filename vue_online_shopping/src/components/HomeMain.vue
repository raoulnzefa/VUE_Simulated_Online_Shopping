                ...
                <section class="product_box">
                    <div class="product_top">
                        <a href="#" class="product_left">
                            ...
                            <strong class="dianshu">On sale at 6:00</strong>
                    ...
                    <div class="share_quality">
                        <div class="share_quality_top">
                            <div class="share_title">
                                <p class="share_text">Recommendation</p>
                            </div>
                        </div>
    ...
    methods:{
        getList(){
            ...
            _this.$http.get('/home').then((res)=>{
                console.log(res);
                _this.homeData.push(res.data[4]);//Four products with time imited cupon
                _this.homeData.push(res.data[1]);
                _this.homeData.push(res.data[2]);
                _this.homeData.push(res.data[3]);
